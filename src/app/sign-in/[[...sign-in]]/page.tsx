...
export default function Page() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#0a0a0f]">
      {/* Quầng sáng nền */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg h-[500px] bg-pink-500/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-[400px]">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">{auth.signInSubtitle}</p>
        </div>
